...
(function() {
  ...
  Range.BrowserRange = (function() {
    ...
    BrowserRange.prototype.normalize = function(root) {
      ...
      nr = {};
      if (r.startOffset > 0) {
        if (r.start.nodeValue && r.start.nodeValue.length > r.startOffset) {
      ...
      if (r.start === r.end) {
        if (nr.start.nodeValue && nr.start.nodeValue.length > (r.endOffset - r.startOffset)) {
    ...
    BrowserRange.prototype._normalizeEnd = function(r) {
      ...
      if (this.endContainer.nodeType === Util.NodeTypes.ELEMENT_NODE) {
        if (this.endContainer.childNodes.length === 0) {
